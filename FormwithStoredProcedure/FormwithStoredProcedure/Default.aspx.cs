    ...
    public partial class Default : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection db = new SqlConnection(con))
            {
                ...
                {
                    using (SqlCommand cmd = new SqlCommand("dbo.Usp_Update", db))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@Name", txtName.Text);
                        cmd.Parameters.AddWithValue("@Mobile", txtMobile.Text);
                        ...
                        {
                            Response.Write("<script>alert('Data Updation Failed!!')</script>");
                        }
                    }
                }
        ...
        protected void OnClick_btnEdit(object sender, EventArgs e)
        {
            ...
            {
                db.Open();
                using (SqlCommand cmd = new SqlCommand("dbo.Usp_Select", db))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        protected void OnClick_btnDelete(object sender, EventArgs e)
        {
            ...
            {
                db.Open();
                using (SqlCommand cmd = new SqlCommand("Usp_Delete", db))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Id", id);
