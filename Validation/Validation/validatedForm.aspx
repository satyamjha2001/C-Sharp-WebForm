<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="validatedForm.aspx.cs" Inherits="Validation.validatedForm" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:ValidationSummary ForeColor="Red" runat="server"/>
            ...
            <table>
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="valName" ControlToValidate="txtName" ErrorMessage="Please enter Name" ForeColor="Red" SetFocusOnError="true" runat="server">*</asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="valEmail" ControlToValidate="txtEmail" ErrorMessage="Please Enter Email" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" runat="server">*</asp:RequiredFieldValidator>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="valAddress" ControlToValidate="txtAddress" ErrorMessage="Please enter address" ForeColor="Red" SetFocusOnError="true" runat="server">*</asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="valDOB" ControlToValidate="txtDOB" ErrorMessage="Please select DOB" ForeColor="Red" SetFocusOnError="true" runat="server">*</asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="valPassword" ControlToValidate="txtPassword" ErrorMessage="Please enter password" ForeColor="Red" SetFocusOnError="true" runat="server">*</asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td>
